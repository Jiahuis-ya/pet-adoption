    ...
    <div class="main-content">
        <div>
            ...
            >
                ...
                >
                     <el-form-item label="知识类型名称" prop="indexNameSearch" class="form_item">
                ...
                <el-row>
                    <el-form-item>
                        <router-link :to="'/knowledge/type/detail/'+ 0 + '/add'">
                            <el-button
                ...
                >
                    ...
                    >
                        <template slot-scope="scope">
                            ...
                            <router-link :to="'/knowledge/type/detail/'+scope.row.id + '/info'">
                                <el-button 
                            ...
                            <router-link :to="'/knowledge/type/detail/'+scope.row.id + '/else'">
                                <el-button 
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                //本表的
                params['dicCode'] = "knowledge_types"//编码名字
                params['dicName'] = "知识分类",//汉字名字
                this.$http({
                    url: "dictionary/page",
                    method: "get",
                    params: params
