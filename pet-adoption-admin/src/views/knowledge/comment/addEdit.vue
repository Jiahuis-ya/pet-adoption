        ...
        >
            <el-row>
                ...
                <el-col :span="24">
                    ...
                    >
                        <span 
                            v-if="roleName === '管理员' || this.type == 'info'"
                            v-html="infoView.commentText"
                        ></span>
                         <el-input 
                            v-else
                            type="textarea"
        ...
        methods: {
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url: `knowledgeComment/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
