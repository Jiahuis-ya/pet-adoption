    ...
    <div class="main-content">
        <div>
            ...
            >
                ...
                <el-row>
                    <el-form-item>
                        <router-link :to="'/admin/detail/'+ 0 + '/add'">
                            <el-button
                                v-if="isAuth('admin/list','新增')"
                                type="success"
                                icon="el-icon-plus"
                ...
                >
                    ...
                    >
                        <template slot-scope="scope">
                            ...
                            <router-link :to="'/admin/detail/'+scope.row.id + '/info'">
                                <el-button 
                                    v-if="isAuth('admin/list','查看')"
                                    type="text"
                                >
                                    详情
                                </el-button>
                            </router-link>
                            <router-link :to="'/admin/detail/'+scope.row.id + '/else'">
                                <el-button 
                                    v-if="isAuth('admin/list','修改')"
                                    type="text"
